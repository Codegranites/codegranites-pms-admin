	...
	return (
		<>
			...
			<div
				...
				className={cn(
					'py-6   flex flex-col w-[98%] sm:w-[95%]  min-[500px]:h-[650px] md:h-[720px] xl:h-[750px] md:w-[682px]  justify-between items-start bg-white backdrop-blur-lg top-10 fixed sm:top-1/2 left-1/2  sm:-translate-y-1/2 z-[999]  transition-all opacity-0 select-none ',
					editProjectModal
			...
			>
				<div className="flex items-center justify-between w-full border-b border-[#e1e1e1] pb-4 pl-4 px-4 md:pl-8 ">
					<h3 className="text-lg md:text-2xl font-medium text-header">Edit Project</h3>
					<button
						type="button"
						tabIndex={0}
						aria-label="Close"
