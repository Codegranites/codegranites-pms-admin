...
const ProjectDetailsSection = ({ project }: { project?: ProjectCardProps }) => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col w-full sm:px-3 py-6 mb-6 sm:border border-[#e1e1e1]  sm:rounded-xl h-full relative dark:bg-gray-950 dark:border-primary-light">
        {/* Details */}
        <div className="flex w-full items-center justify-between pb-2 md:pb-3 border-b border-[#e1e1e1] dark:border-primary-light">
          ...
          <button
            ...
            className="focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-light rotate-90 text-header dark:text-gray-200"
          >
            <More />
          </button>
        </div>
        ...
        <div
          ...
          className={cn(
            'flex w-[190px] h-[106px] flex-col px-4 py-2 absolute right-2 top-[3.5rem] rounded-lg justify-center gap-y-4 border border-gray-200 dark:border-primary-light backdrop-blur-xl bg-white/80 dark:bg-gray-950/70 transition-all duration-300 z-[999]',
            {
        ...
        >
          <button
            ...
            type="button"
            tabIndex={0}
            className="focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-light w-full flex items-center gap-x-2 px-2 text-header dark:text-gray-200"
          >
            <Edit2 size={18} />
        ...
        <div className="flex w-full flex-col py-5 gap-y-3 lg:gap-y-4">
          <p className="text-sm xl:text-base text-header dark:text-gray-200 flex flex-wrap items-center gap-x-1">
            ...
            <span className="text-primary-light dark:text-color-dark text-[11px]">
          ...
          <p
            className={cn(
              'text-sm xl:text-base text-header dark:text-gray-200 flex items-center gap-x-1'
            )}
          >
            Project Status:
            <span
        ...
        <div className="flex flex-col sm:rounded-xl mb-7 bg-[#f6f6f6] dark:bg-gray-900 gap-y-3 lg:gap-y-4 p-4">
          <p className="text-sm xl:text-base text-header dark:text-gray-200 flex items-center gap-x-1">
