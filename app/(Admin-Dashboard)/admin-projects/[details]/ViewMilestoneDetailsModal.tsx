  ...
  return (
    <>
      ...
      <div
        ...
        className={cn(
          'py-6   flex flex-col max-[350px]:h-[410px] w-[90%] h-[380px] min-[550px]:w-[500px] md:w-[682px] md:h-[400px] items-center bg-white dark:bg-gray-900  fixed top-1/2 left-1/2  z-[999]  transition-all opacity-0 select-none  -translate-y-1/2 -translate-x-1/2',
          viewMilestoneModal
      ...
      >
        ...
        <div className="flex w-full  pt-8  flex-col gap-y-4 ">
          <p className="text-sm md:text-base px-4">
            ...
            <span className="dark:text-gray-100">{milestone?.title}</span>
          </p>
          <p className="text-sm md:text-base px-4">
            <span className="font-medium dark:text-gray-100">
              Milestone Status:{' '}
          ...
          <p className="text-sm md:text-base px-4 ">
            ...
            <span className="dark:text-gray-200">{milestone?.description}</span>
          </p>
        </div>
