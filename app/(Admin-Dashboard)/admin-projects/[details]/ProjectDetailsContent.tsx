...
const ProjectDetailsContent = ({ id }: { id?: string }) => {
	...
	return (
		<>
			...
			<section className="w-full flex flex-col lg:flex-row justify-between gap-4 sm:gap-6 lg:gap-8 xl:gap-12  pb-16 items-center lg:items-start min-h-screen pt-4">
