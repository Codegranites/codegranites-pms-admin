  ...
  return (
    <>
      ...
      <div
        ...
        className={cn(
          'py-6   flex flex-col w-[360px] h-[300px] min-[450px]:w-[400px] min-[550px]:w-[500px] md:w-[682px] md:h-[400px] justify-between items-center bg-white backdrop-blur-lg fixed top-1/2 left-1/2  -translate-y-1/2 z-[999]  transition-all opacity-0 select-none -translate-x-1/2',
          openModal
