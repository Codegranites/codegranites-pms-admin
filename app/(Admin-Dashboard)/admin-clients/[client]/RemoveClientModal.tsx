  ...
  return (
    <>
      ...
      <div
        ...
        className={cn(
          'py-6   flex flex-col w-[360px] h-[300px] min-[450px]:w-[400px] min-[550px]:w-[500px] md:w-[682px] md:h-[400px] justify-between items-center bg-white dark:bg-gray-900 backdrop-blur-lg fixed top-1/2 left-1/2  -translate-y-1/2 z-[999]  transition-all opacity-0 select-none -translate-x-1/2',
          openModal
      ...
      >
        <div className="flex items-center justify-between w-full border-b border-[#e1e1e1] dark:border-primary-light pb-4 pl-4 px-4 md:pl-8 ">
          <h3 className="text-lg md:text-2xl font-medium text-header dark:text-gray-100">
            Remove{' '}
            <span className="font-semibold tracking-wide lg:font-bold">
              {clientName ?? 'Client'}
            </span>
          </h3>
          <button
        ...
        <div className="flex w-full max-w-[546px] h-full  pt-8 sm:pt-16 items-center flex-col gap-y-8 ">
          <p className="text-center text-sm md:text-base px-4 dark:text-gray-300">
            ...
            from the CodeGranites workspace? Remember this action cannot be
            reversed{' '}
          </p>
