...
const Transaction = () => {
	return (
		<section className="flex flex-col w-full py-6 sm:border  border-r-[#e1e1e1] h-full items-center justify-center lg:pb-16">
			...
			<div className="items-center justify-center sm:max-w-[300px] xl:max-w-[450px]">
				<p className="text-header sm:font-medium lg:text-xl w-full  text-center">No transactions have been made yet!</p>
			</div>
		</section>
	);
};
