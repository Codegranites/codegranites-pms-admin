...
import ModMobileSidebar from '../sidebars/ModMobileSidebar';

const ModeratorNavbar = () => {
	const { currentPath, modShowMobileMenu, setModShowMobileMenu, user } = useStateCtx();
			...
			>
				<button
					...
					className={cn(
						...
						{
							'rotate-45 absolute right-1 top-1 z-[9999] text-white': modShowMobileMenu
						}
					)}
