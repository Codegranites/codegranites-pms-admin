...
function Container({ children, isEmpty, title, Icon, emptyIllustration, emptyText, Create }: Props) {
	return (
		<div
			className={`bg-white rounded-2xl ${
				isEmpty ? 'shadow-[0px_4px_40px_6px_rgba(0,0,0,0.06)]' : 'border border-[#E1E1E1]'
			}`}
		>
