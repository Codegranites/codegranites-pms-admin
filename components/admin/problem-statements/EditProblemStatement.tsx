...
export default function EditProblemStatement({ isOpen, onClose, title, description }: EditProblemStatementProps) {
	...
	return (
		<Modal closeOnOverlayClick={false} isOpen={isOpen} closeModal={onClose} size="sm" title="Edit problem statement">
			<form action="" className="text-base leading-[22px] flex flex-col gap-y-7 pt-8">
				...
				<Button type="submit" className="w-full rounded-lg text-sm mt-10 mb-2 font-medium">
					Save Changes
				</Button>
			</form>
		</Modal>
