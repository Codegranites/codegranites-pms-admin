...
export default function AttachNewFile({ isOpen, onClose, title }: AttachNewFileProps) {
	return (
		<Modal closeOnOverlayClick={true} isOpen={isOpen} closeModal={onClose} size="xl" title={`${title}`}>
			<div className="space-y-10 pt-10">
				<div className="py-4 border border-[#E1E1E1] rounded-2xl">
					...
					<div>
						<ul className="px-6 pt-6 pb-4">
							<li className="flex items-center justify-between pb-2 border-b text-[#6F6F6F] font-normal">
								<div className="flex items-center gap-x-2 text-base leading-8">
									...
									<p>
										<span className="text-header">Project proposal</span> <span>.pdf</span>
									</p>
								</div>
						...
						<p className="text-[#052C42] underline text-xs leading-4 ml-10 font-medium">See All</p>
					</div>
				</div>
