...
import { selectCurrencies, selectStatus } from '../../../app/(Admin-Dashboard)/admin-projects/[details]/edit-project';
...
const CreateProjectModal = () => {
	...
	const currenySymbol = selectCurrencies.find((c) => c.value === formData.currency)?.symbol;
	...
	useEffect(() => {
		if (!(formData.title.length > 3) || !(formData.description!.length > 3)) return;
