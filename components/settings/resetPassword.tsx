...
const ResetPassword = () => {
	...
	const handlePasswordChange = (e: React.ChangeEvent<HTMLInputElement>) => {
		...
		setIsResetDisabled(!isStrongPassword(e.target.value) || currentPassword === '');
	};
	...
	return (
		<div className="flex flex-col max-w-[680px] w-[620px] mt-5 justify-center">
			...
			<div className="mb-4">
				<label htmlFor="currentPassword" className="block text-lg font-normal text-black">
					Current Password
				</label>
				<Input
					type={defaultInpType}
			...
			<div className="mb-4">
				<label htmlFor="newPassword" className="block text-lg font-normal text-black">
					New Password
				</label>
