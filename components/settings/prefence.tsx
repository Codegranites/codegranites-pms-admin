			...
			<div className="w-[620px] max-w-[680px] px-[32px] justify-center items-center">
				<div className="mr-[80px] mt-9 flex justify-center items-center">
					<div className="relative w-full flex-col pr-6 justify-center ">
						<Image src={images[currentImageIndex]} alt="user" width={250} height={250} />
					...
					<div className="flex-col">
						<Button className="border w-[206px] h-[70px] mb-5 bg-transparent text-black" onClick={handleChangeImage}>
							Change Photo
						</Button>
						<Button className="border w-[206px] h-[70px] bg-transparent text-[#FF0000]" onClick={handleDeleteImage}>
							Delete Photo
						</Button>
					</div>
				</div>
