...
const WorkSpaceCard: React.FC<WorkspaceCardProps> = ({
  ...
  return (
    <div
      ...
      className={cn(
        'md:w-[500px] relative h-full sm:w-ful  bg-card  flex flex-col p-[6px] rounded-lg xl:rounded-xl transition-all duration-1000 hover:delay-0 hover:duration-500 hover:shadow-[0_10px_30px_0_rgba(0,0,0,0.2)]   border border-gray-200 hover:border-none card',
        isInView
    ...
    >
      ...
      <div className="card-content flex-col flex bg-card p-2 justify-start items-start">
