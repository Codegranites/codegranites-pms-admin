	...
	return (
		<div
			className={cn(
				...
				{ 'opacity-100 delay-500': swipeIndicator, 'pointer-events-none': !swipeIndicator }
			)}
			aria-hidden
		>
			<Image src="/swipe.gif" priority loading="eager" width={150} height={150} alt="swipe" className="invert" />
			...
			<button
				type="button"
				className="text-white bg-primary-light px-3 py-1 rounded-md mt-1 font-medium uppercase active:scale-75 transition-all duration-300"
				onClick={() => {
